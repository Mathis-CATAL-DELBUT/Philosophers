...
/*   Updated: 2023/04/14 04:54:28 by mcatal-d         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_print(t_philo *philo, char *str)
{
	...
	if (philo->data->stop_flag == 1 && ft_strncmp(str, "died", 7))
	{
...
void	*action_philo(void *arg)
{
	...
	while (1)
	{
		...
		pthread_mutex_unlock(&philo->data->flag);
		ft_usleep(((philo->data->t_death - \
			(philo->data->t_eat + philo->data->t_sleep)) / 2));
	}
	return (NULL);
}
